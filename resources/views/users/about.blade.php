                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 px-xl-4 mt-4 mt-xl-0">
                        <div class="pq-section pq-style-1 text-left"> <span class="pq-section-sub-title">What About Us</span>
                            ...
                            <p class="pq-section-description">There are many variations of passages of Lorem Ipsum available,
                                but the majority have suffered alteration in some form, by injected humour.</p>
                        </div>
                        <div class="row mt-3">
                            <div class="col-lg-6 col-md-6">
                                <ul class="pq-list-check ">
                                    <li><i aria-hidden="true" class="ion ion-checkmark-round"></i><span>Intervention
                                            Success</span></li>
                                    <li><i aria-hidden="true" class="ion ion-checkmark-round"></i><span>Quality of Care
                                            Services</span></li>
                                    <li><i aria-hidden="true" class="ion ion-checkmark-round"></i><span>Client
                                            Satisfaction</span></li>
                                </ul>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <ul class="pq-list-check">
                                    <li><i aria-hidden="true" class="ion ion-checkmark-round"></i><span>Happy with Staff</span>
                                    </li>
                                    <li><i aria-hidden="true" class="ion ion-checkmark-round"></i><span>Infection
                                            Prevention</span></li>
                                    <li><i aria-hidden="true" class="ion ion-checkmark-round"></i><span>Patient
                                            Experience</span></li>
                                </ul>
                            </div>
                                ...
                                <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                    ...
                                    <div class="pq-blog-contain">
                                        ...
                                        <h5 class="pq-blog-title"><a href="get-the-exercise-limited-mobility.html">What is
                                                Future of Blood Pressure Monitoring?</a></h5>
                                        <div class="pq-blog-info">
                                            <p>It is a long established fact that a reader will be distracted by the readable
                                                content of a page when looking at its layout.</p>
                                        </div>
                            ...
                            <div class="item">
                                <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                    ...
                                    <div class="pq-blog-contain">
                                        ...
                                        <h5 class="pq-blog-title"><a href="get-the-exercise-limited-mobility.html">Goals Setting
                            ...
                            <div class="item">
                                <div class="pq-blog-post pq-style-1 pq-bg-grey">
                                    ...
                                    <div class="pq-blog-contain">
                                        ...
                                        <h5 class="pq-blog-title"><a href="get-the-exercise-limited-mobility.html">Hard content
