...
@section('description')
{{-- @section('{{Str::slug($surgical->title)}}') --}}
            ...
            <div class="col-lg-12">
                <nav aria-label="breadcrumb">
                    <div class="pq-breadcrumb-title">
                        <h2 class="pq-section-title"> Surgical Outreach </h2>
                    </div>
                    <div class="pq-breadcrumb-container mt-2">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('welcome')}}"><i
                                        class="fas fa-home mr-2"></i>Home</a></li>
                            <li class="breadcrumb-item active"> Surgical Outreach </li>
                        </ol>
                    </div>
                </nav>
            </div>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 col-md-12">
                <div class="pq-blog-post">
                    <div class="pq-post-media"> <img src="/storage/surgical/{{$surgical->image}}" class="img-fluid"
                            alt="medicate">
